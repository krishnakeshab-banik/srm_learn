// Community Content Section (like linked list)
"use client"
  ...
  return (
    <section className="mb-8">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded p-4 text-yellow-800 my-4">
        <p>
          <b>Share your Stack questions, solutions, and tips!</b>
        </p>
        <ul className="list-disc pl-6 mt-2 text-sm">
          <li>Post your own stack problems and solutions</li>
          <li>Discuss tricky stack interview questions</li>
          <li>Share visualizations, YouTube videos, or helpful links</li>
          <li>Help others by answering their stack-related doubts</li>
        </ul>
        <div className="mt-4">
