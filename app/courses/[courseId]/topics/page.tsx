...
export default function CourseTopicsPage({ params }: { params: { courseId: string } }) {
  const topics = [
    ...
    { id: "ds-stack", title: "5- DS Stack", icon: <Layers className="h-6 w-6 text-orange-500" />, available: false },
    { id: "ds-queue", title: "6- DS Queue", icon: <List className="h-6 w-6 text-red-500" />, available: false },
    { id: "ds-tree", title: "7- DS Tree", icon: <GitMerge className="h-6 w-6 text-emerald-500" />, available: false },
    { id: "ds-graph", title: "8- DS Graph", icon: <Network className="h-6 w-6 text-cyan-500" />, available: false },
    {
      id: "ds-searching",
    ...
    { id: "ds-mcq", title: "11- DS MCQ", icon: <FileCode className="h-6 w-6 text-teal-500" />, available: true },
    {
      id: "singly-linked-list",
      title: "12- Singly Linked List",
      icon: <GitBranch className="h-6 w-6 text-violet-500" />,
      available: false,
    },
    {
      id: "doubly-linked-list",
      title: "13- Doubly Linked List",
      icon: <GitBranch className="h-6 w-6 text-pink-500" />,
      available: false,
    },
    {
      id: "circular-linked-list",
      title: "14- Circular Linked List",
      icon: <GitPullRequest className="h-6 w-6 text-rose-500" />,
      available: false,
    },
    {
      id: "circular-doubly-linked-list",
      title: "15- Circular Doubly Linked List",
      icon: <GitPullRequest className="h-6 w-6 text-fuchsia-500" />,
      available: false,
    },
    {
      id: "binary-tree",
      title: "16- Binary Tree",
      icon: <GitMerge className="h-6 w-6 text-lime-500" />,
      available: false,
    },
    {
      id: "binary-search-tree",
      title: "17- Binary Search Tree",
      icon: <GitMerge className="h-6 w-6 text-yellow-500" />,
      available: false,
    },
    { id: "avl-tree", title: "18- AVL Tree", icon: <GitMerge className="h-6 w-6 text-sky-500" />, available: false },
    {
      id: "miscellaneous-exercise",
      title: "19- Miscellaneous Exercise",
